...
public class ShakeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flag == 1) {
                    Toast.makeText(ShakeMainActivity.this, "ACTIVATED!", Toast.LENGTH_LONG).show();
                    startService(new Intent(getApplicationContext(), ShakeService.class));
                    flag = 0;
                } else {
                    Toast.makeText(ShakeMainActivity.this, "DEACTIVATED!", Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.aboutM) {
            startActivity(new Intent(ShakeMainActivity.this,About.class));
        }
